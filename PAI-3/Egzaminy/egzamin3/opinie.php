...
<body>
    ...
    <main>
        ...
        <?php
        $query2 = mysqli_query($mysqli, "SELECT klienci.zdjecie, klienci.imie, opinie.opinia
        FROM klienci
    ...
    <footer>
        ...
        <section>
            ...
            <?php 
                $query1 = mysqli_query($mysqli, "SELECT klienci.imie, klienci.nazwisko, klienci.punkty
                FROM klienci
